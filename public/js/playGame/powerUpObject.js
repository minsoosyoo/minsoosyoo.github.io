class PowerUpClass {
    constructor() {
        ...
        {playerPower: {laserBeamDuration: 500}, num: 4, message: "laser beam lasts +0.5 seconds"}, 
        {playerPower: {laserBeamReload: -5000}, num: 3, message: "laser beam cooldown -5 seconds"},
